                        ...
                        <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-body">
                                <div class="form-group form-md-line-input has-info">
                                    <input type="text" class="form-control" placeholder="Add Customer Type" name="profname">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group form-md-line-input listofbaseprice">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="baseprice_<?php echo $categsvalue['meta_id']; ?>_<?php echo $sizevalue['meta_id']; ?>" value="0">
                                                                        <!-- <span class="help-block">Some help goes here...</span> -->
